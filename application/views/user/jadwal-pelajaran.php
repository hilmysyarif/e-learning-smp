...
<div class="postingan">
<div class="single-kontak">
	<?php echo form_open('p_user/tampil_data_jadwal'); ?>
		...
		<div class="isi-postingan">
			<h2 style="text-align: left;"><span>Jadwal Pelajaran Kelas <?php echo $nama_kelas['kelas']; ?> | Semester <?php echo $nama_semester['semester']; ?> | Tahun Ajaran <?php echo $nama_tahun_ajaran['tahun_ajaran']; ?></span><?php if($this->session->userdata('login_admin')) { ?><a href="<?php echo site_url('p_admin/hapus_jadwal?kelas='.$nama_kelas['id_kelas'].'&semester='.$nama_semester['id_semester'].'&tahun_ajaran='.$nama_tahun_ajaran['id_tahun_ajaran']); ?>"><i class="glyphicon glyphicon-trash pull-right"></i></a><?php } ?></h2>
