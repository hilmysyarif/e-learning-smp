...
<div class="postingan">
	...
	<div class="single-biodata">
		...
		<p><span class="jdl-biodata">Tahun Masuk</span><span>: </span>
		...
		<p><span class="jdl-biodata">Password</span><span>: </span><input name="password_siswa" type="text" value="<?php echo $siswa['password_siswa']; ?>"></p>
		...
		<p><span class="jdl-biodata">Password</span><span>: </span><input name="password_wali" type="text" value="<?php echo $siswa['password_wali']; ?>"></p>
