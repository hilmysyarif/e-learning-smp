...
<img src="<?php echo base_url('resource/img/photo/11.11.5304.jpg') ?>" width="180px" height="190px" style="margin: 10px;">
<ul class="menu-login">
	<li><a href="<?php echo site_url('guru/upload'); ?>"><i class="glyphicon glyphicon-upload"></i> Upload Data</a></li>
	<li><a href="<?php echo site_url('guru/biodata'); ?>"><i class="glyphicon glyphicon-user"></i> Biodata</a></li>
