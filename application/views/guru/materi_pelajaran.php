...
<div class="postingan">
	...
	<div class="isi-postingan">
		<h2><span>Matematika </span> | <span> Kelas 3 A</span></h2>
		...
		<tbody>
			<tr>
				...
				<td><span class="kolom-mtr"><a href="<?php echo site_url('guru/detail_materi'); ?>"> Perancangan Aplikasi dengan Metode Dunia Lain.pdf</a></span></td>
			</tr>
		</tbody>
	</table>
	</div>
