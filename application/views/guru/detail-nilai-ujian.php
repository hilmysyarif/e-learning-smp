		...
		<table class="table table-bordered table-striped">
			<tbody>
				...
				<tr>
					...
					<td><span class="desc-detail">Nilai Bahasa Indonesia</span></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><span class="desc-detail"><a href="<?php echo site_url('guru/ubah_nilai'); ?>">Ubah</a> | <a href="#">Hapus</a></span></td>
				</tr>
			</tbody>
		</table>
	</div>
